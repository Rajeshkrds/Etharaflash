...
public class Ethara_Blog_subscription {
...
//	@FindBy(xpath="//div[contains(text(),'Country Code')]")
	...
	public Ethara_Blog_subscription(WebDriver driver) {
	...
	public void select_business() {
		...
		if (business_radio_button.isSelected())
			log.info("Business radio button is Aleadry select");
		else {
	...
	public void select_personal() {
		...
		if (persoanl_radio_button.isSelected())
			log.info("Personal radio button is Aleadry select");
		else {
